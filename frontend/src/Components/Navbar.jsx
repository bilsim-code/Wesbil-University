...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      location.pathname ===
        ...
        <>
          <div className="flex items-center gap-5">
            <Home
              className="text-white invisible cursor-pointer w-6 h-8"
          ...
          location.pathname ===
            ...
            <>
              ...
              <li className="nav-li pb-6 text-white nav-ul-md:text-white nav-ul-md:p-0 nav-ul-md:pr-[30px] font-medium">
                <RouterLink
                  onClick={() => setMenuShow(false)}
                  to={"student-portal/eregistrar"}
                  className={`hover:border-b-4 border-solid border-gold pb-1 hover:text-gold transition-colors duration-400 ease-linear ${location.pathname === "/student-portal/eregistrar" ? "border-b-4 border-solid border-gold" : ""} `}
                >
                  E-Registrar
                </RouterLink>
              </li>
              ...
              <li className="nav-li pb-6 text-white nav-ul-md:text-white nav-ul-md:p-0 nav-ul-md:pr-[30px] font-medium">
                <RouterLink
                  onClick={() => setMenuShow(false)}
                  to={"student-portal/elearning"}
                  className={`hover:border-b-4 border-solid border-gold pb-1 hover:text-gold transition-colors duration-400 ease-linear ${location.pathname === "/student-portal/elearning" ? "border-b-4 border-solid border-gold" : ""} `}
                >
                  E-Learning
                </RouterLink>
              </li>
              ...
              <li className="nav-li pb-6 text-white nav-ul-md:text-white nav-ul-md:p-0 nav-ul-md:pr-[30px] font-medium">
                {location.pathname === "/" ? (
                  <ScrollLink
                    ...
                    offset={100}
                    onClick={() => setMenuShow(false)}
                    className="cursor-pointer hover:border-b-4 border-solid border-gold pb-1 hover:text-gold transition-colors duration-400 ease-linear no-underline"
                  >
                    Schools
                  </ScrollLink>
                ) : (
            ...
            >
              ...
              <OutsideClickHandler
                onOutsideClick={() => setLinkDropdownOn(false)}
              >
                {/* Dropdown */}
                <li className="nav-li pb-6 text-white nav-ul-md:text-white nav-ul-md:p-0 nav-ul-md:pr-[30px] font-medium ">
                  <div
      ...
      location.pathname === "/student-portal/eregistrar/examresults" ||
      location.pathname === "/student-portal/eregistrar/feestatement" ||
      location.pathname === "/student-portal/eregistrar/hostel" ||  location.pathname === "/student-portal/eregistrar/hostel/reserve-bed" ||
      location.pathname === "/student-portal/eregistrar/profile" ||
      location.pathname ===
        "/student-portal/eregistrar/profile/change-password" ? (
