    ...
    <>
      ...
      <div className="grid grid-cols-5 max-1300px:grid-cols-4 max-1080px:grid-cols-3 max-840px:grid-cols-2 max-480px:grid-cols-1 gap-y-6 place-items-center bg-gray-fade rounded-md p-4 py-6">
        <Link
          ...
          className="bg-white rounded-lg rounded-r-none hover:shadow-2xl hover:-translate-y-1 hover:duration-300 p-5 w-[220px] max-609px:w-[160px] max-w-full shadow-xl flex flex-col border-l-[4px] uppercase font-semibold gap-4 h-[140px] max-609px:h-[140px] max-480px:w-full"
        >
