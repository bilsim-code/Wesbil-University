...
const Sob = () => {
  ...
  return (
    <div>
      <div className="hero bg-sobHero h-[100vh] bg-no-repeat bg-center bg-cover flex items-center justify-center text-center">
        <div className="flex flex-col ">
          <h2 className="text-3xl font-bold ">
            Welcome to Wesbil University School of Business
          </h2>
      ...
      <div className="mt-20 px-4 max-w-5xl mx-auto">
        ...
        <div className="bg-contactImg bg-no-repeat bg-right bg-cover h-[100vh] flex flex-col gap-10 rounded-md mt-10 shadow-xl">
          {/* join us */}
          <div className="flex basis-[50%] flex-col gap-4 bg-royalblue  px-3 py-5 rounded-md footer-md:flex-row footer-md:items-center">
            ...
            <p className="text-white">
              ...
              create a better future for businesses and communities worldwide
            </p>
          </div>
          {/* form */}
