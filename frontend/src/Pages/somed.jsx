...
const Somed = () => {
  ...
  return (
    <div>
      <div className="somed-hero bg-somedHero h-[100vh] bg-no-repeat bg-right bg-cover flex items-center justify-center text-center">
      ...
      <div className="mt-20 px-4 max-w-5xl mx-auto">
        ...
        <div className="somed-contactImg bg-fixed bg-no-repeat bg-center bg-cover h-[100vh] flex flex-col gap-10 rounded-md mt-10 shadow-xl">
          {/* join us */}
